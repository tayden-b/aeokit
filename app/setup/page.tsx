      ...
      <main className="mx-auto max-w-3xl px-6 pt-16 pb-24">
        ...
        <section className="mt-12">
          ...
          <ul className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
            <li>
              <span className="font-medium text-foreground">An API key from at least one engine.</span>{' '}
              OpenAI is the minimum. Add Gemini, Anthropic, or Perplexity keys to measure across more
              engines — cross-engine disagreement is where the useful findings usually are.
            </li>
            <li>
        ...
        <section className="mt-16 rounded-xl border border-border bg-muted/30 p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Replace with your own product and who buys it. That&apos;s the whole interface.
          </p>
