    ...
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
          <div className="col-span-2"><Link href="/" className="flex items-center gap-2"><MarketMakerLogo className="size-7 text-primary" /><span className="font-mono text-sm font-medium tracking-tight text-foreground">marketmaker.ai</span></Link><p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">An MCP-first tool that gives AI agents live, repeatable measurements of what answer engines recommend.</p><p className="mt-4 font-mono text-[11px] text-muted-foreground">NOT ANOTHER PLATFORM. ONE MORE CAPABILITY.</p></div>
